...
для переноса на другое устройство или как бэкап. Видео-аватарки существ
...
- Аватарки существ в бестиарии можно сделать видео (до 30 МБ) — не
  только фото или эмодзи; видео проигрывается прямо в кружке аватарки
  (без звука, зациклено)
- У существ теперь есть подтип — например «Гуманоид (гоблиноид)»,
  показывается рядом с типом в списке и в карточке существа
- У каждого персонажа можно задать свой цвет имени
- Ещё две темы оформления: Кофейная и Україна (сине-жёлтая), тёплая
  тема «Пламя», и «Ирландский клевер» — с узором из листьев клевера,
  замощённым по всему экрану во всех разделах
...
- Встроенные кубики (d4–d100): SVG-рендер с выбором скина (рубин/золото/
  ...
  успех/провал
- 8 тем оформления, атмосферные звуки, анимированная заставка при запуске
