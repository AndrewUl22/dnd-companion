...
- Ещё две темы оформления: Кофейная и Україна (сине-жёлтая), плюс тёплая
  тема «Пламя»
...
- Встроенные кубики (d4–d100): SVG-рендер с выбором скина (рубин/золото/
  изумруд/аметист/обсидиан), анимация броска с покачиванием, вспышка
  на критический успех/провал для d20
- 7 тем оформления, атмосферные звуки, анимированная заставка при запуске
